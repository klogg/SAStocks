...
def save_to_db(date, ticker, historical_price_high, historical_price_low, historical_price_avg, recent_price, rsi, macd):
    query = """
        ...
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    """
    connection.cursor().execute(query, (date, ticker, None, None, None, historical_price_high,
                                        historical_price_low, historical_price_avg, None, recent_price, rsi, macd))
...
def main():
    ...
    for ticker in tickers:
        ...
        save_to_db(date, ticker, historical_price_high, historical_price_low,
                   historical_price_avg, recent_price, rsi, macd)
